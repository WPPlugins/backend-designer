...
function ddbd_text_field_5_render(  ) {
    ...
    <div class="uploader">
        <input class="ddbd_options_upload" id="upload_image_login_logo" type="text" size="36" name="ddbd_settings[login-logo]" value="<?php echo $ddbd_options['login-logo'] ?>" />
...
function ddbd_text_field_5_1_render(  ) {
    ...
    <div class="uploader">
        <input class="ddbd_options_upload" id="upload_image_login_bg" type="text" size="36" name="ddbd_settings[login-bg]" value="<?php echo $ddbd_options['login-bg'] ?>" />
...
function ddbd_text_field_6_render(  ) {
    ...
    $ddbd_options = get_option( 'ddbd_settings' );
    ?>
    <input class="ddbd_options_field_login_bgcolor" type='text' name='ddbd_settings[login-bgcolor]' value='<?php echo $ddbd_options['login-bgcolor']; ?>'>
...
function ddbd_text_field_7_render(  ) {
    ...
    $ddbd_options = get_option( 'ddbd_settings' );
    ?>
    <input class="ddbd_options_field_login_textcolor" type='text' name='ddbd_settings[login-textcolor]' value='<?php echo $ddbd_options['login-textcolor']; ?>'>
