...
function ddbd_output_styles() {
   ...
   if ( $ddbd_current_scheme != "backend_designer" ) {
    ...
    <style type="text/css">
        ...
        #wpadminbar .ab-top-menu > li.hover > .ab-item, #wpadminbar.nojq .quicklinks .ab-top-menu > li > .ab-item:focus, #wpadminbar:not(.mobile) .ab-top-menu > li:hover > .ab-item, #wpadminbar:not(.mobile) .ab-top-menu > li > .ab-item:focus a,
        ...
        {
            <?php if(isset($secondarytext)) { ?>
                color: <?php echo $secondarytext ?>;
            <?php } ?>
        }
        ...
        .wp-core-ui .button-primary:focus,
        .wp-core-ui .button-primary:hover {
            <?php if(isset($focuscolor)) { ?>
                background: <?php echo $focuscolor ?>;
            <?php } ?>
        }
        ...
        .wp-core-ui .button-primary:hover {
            <?php if(isset($focuscolor)) { ?>
                box-shadow: 0 1px 0 <?php echo $focuscolor ?>;
...
function ddbd_login_screen_customize() {
    ...
    $ddbd_options = get_option('ddbd_settings');
    $logoUrl = $ddbd_options['login-logo'];
    $loginBgColor = $ddbd_options['login-bgcolor'];
    $loginBgImage = $ddbd_options['login-bg'];
    $loginTextColor = $ddbd_options['login-textcolor'];
    ...
    <style type="text/css">
        ...
        body.login {
            <?php if ( isset($loginBgColor) ) { ?>
                background: <?php echo $loginBgColor ?>;
            <?php } ?>
            <?php if ( isset($loginBgImage) ) { ?>
                background: url(<?php echo $loginBgImage ?>) 0 0 no-repeat;
                background-size: cover;
            <?php } ?>
        }
        body.login a {
            <?php if ( isset($loginTextColor) ) { ?>
                color: <?php echo $loginTextColor; ?>!important;
            <?php } ?>
        }
